...
ABOUT_TXT = os.environ.get("ABOUT_MESSAGE", "<i><b><blockquote>◈ ғᴏʀ ᴍᴏʀᴇ: <a href=https://t.me/cantarellabots>CantarellaBots</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/cantarellabots>CantarellaBots</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/about_zani/117'>ZANI</a>\n◈ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>ᴍᴏɴɢᴏ ᴅʙ</a>\n◈ ʟᴀɴɢᴜᴀɢᴇ: <a href='https://t.me/about_zani/117'>ZANI</a></blockquote></b></i>")
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1003720439808"))
